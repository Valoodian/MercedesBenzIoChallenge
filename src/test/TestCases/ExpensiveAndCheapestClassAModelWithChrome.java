...
public class ExpensiveAndCheapestClassAModelWithChrome {

    //////////////////////////////////////////////////////////////////////////////////////// This spaced is used as pre-condition to create all the used variables //////////////////////////////////////////////////////////////////////////
    ...
    void TestSteps() throws InterruptedException, IOException {
        ...
        FileUtils.copyFile(screenshot,new File("C:\\MBioChallenge\\AvailableDieselModelsWithChrome.png"));
